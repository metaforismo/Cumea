...
replaceOnce(
  "TODO.md",
  '| 2026-08-18 | Competitive audit refresh | Re-audited Cumea `4b897646` against Rakazo `9622c388` and OpenMausBot `e7d71f4b`; promoted Runtime/Raw diagnostics, draft-#9 extraction, busy-user steering, engine/session freshness, package spawn-closure verification, app-wide accessibility/motion, mobile discovery/notifications, connector continuation, provider onboarding and bounded subagent controls into explicit gates. |\n',
