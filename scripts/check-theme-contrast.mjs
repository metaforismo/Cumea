...
export const THEME_CONTRAST_PAIRS = [
  ...
  { foreground: "accent", background: "app", minimum: 4.5, use: "normal accent text / app" },
  { foreground: "accent", background: "card", minimum: 4.5, use: "normal accent text / card" },
  { foreground: "accent", background: "inset", minimum: 4.5, use: "normal accent text / inset" },
