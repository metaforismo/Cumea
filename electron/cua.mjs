...
//    EmbeddedCuaDriverHost so TCC grants attribute to Cumea and the
//    driver inherits them. One prompt, named Cumea, out of the box.
...
export async function startCua() {
  ...
  const wantEmbedded =
    app.isPackaged || process.env.CUMEA_CUA_EMBEDDED === "1";
