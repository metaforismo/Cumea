...
test("wait ignores unrelated messages and resolves once", async () => {
...
test("wait fails when child exits before announcing readiness", async () => {
...
test("wait rejects malformed readiness from the exact child", async () => {
...
test("wait times out instead of polling a port", async () => {
